 ...
 *
 * Disassembly of dsdt.dat, Fri Sep  4 22:44:16 2015
 *
...
DefinitionBlock ("dsdt.aml", "DSDT", 2, "INTEL ", "EDK2    ", 0x00000003)
{
    ...
    External (MDBG, MethodObj) /* NOT FOUND IN SSDTs */
    ...
    Name (PEER, One)
    Name (PECS, One)
    OperationRegion (GNVS, SystemMemory, 0x7945DA98, 0x031E)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (SBUS)
        {
            ...
            Method (SRXB, 1, Serialized)
            {
                ...
                {
                    HSTS |= 0xFF
                    Return (DAT0) /* \_SB_.PCI0.SBUS.SRXB.DAT0 */
                }
            ...
            Method (SRDB, 2, Serialized)
            {
                ...
                {
                    HSTS |= 0xFF
                    Return (DAT0) /* \_SB_.PCI0.SBUS.SRDB.DAT0 */
                }
            ...
            Method (SBLR, 3, Serialized)
            {
                ...
                Index (TBUF, Zero) = DAT0 /* \_SB_.PCI0.SBUS.SBLR.DAT0 */
                HSTS = 0x80
                Local1 = One
                While ((Local1 < DerefOf (Index (TBUF, Zero))))
                {
                    ...
                    Index (TBUF, Local1) = HBDR /* \_SB_.PCI0.SBUS.SBLR.HBDR */
                    HSTS = 0x80
                    Local1++
                }
