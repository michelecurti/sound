...
#define RT5648_DEVICE_ID 0x6308

#define RT5648_PR_RANGE_BASE (0xff + 1)
#define RT5648_PR_SPACING 0x100

#define RT5648_PR_BASE (RT5648_PR_RANGE_BASE + (0 * RT5648_PR_SPACING))
...
static const struct regmap_range_cfg rt5648_ranges[] = {
	{
		.name = "PR",
		.range_min = RT5648_PR_BASE,
		.range_max = RT5648_PR_BASE + 0xf8,
		.selector_reg = RT5648_PRIV_INDEX,
		.selector_mask = 0xff,
		.selector_shift = 0x0,
		.window_start = RT5648_PRIV_DATA,
		.window_len = 0x1,
	},
};

static const struct reg_sequence init_list[] = {
	{RT5648_PR_BASE + 0x3d,	0x3600},
	{RT5648_PR_BASE + 0x1c,	0xfd20},
	{RT5648_PR_BASE + 0x20,	0x611f},
	{RT5648_PR_BASE + 0x21,	0x4040},
	{RT5648_PR_BASE + 0x23,	0x0004},
};

static const struct reg_default rt5648_reg[] = {
	{ 0x01, 0xc8c8 },
	{ 0x02, 0xc8c8 },
	{ 0x03, 0xc8c8 },
	{ 0x0a, 0x0002 },
...
struct rt5648_eq_param_s {
	unsigned short reg;
	unsigned short val;
};

static const char *const rt5648_supply_names[] = {
	"avdd",
	"cpvdd",
};
...
struct rt5648_priv {
	...
	struct rt5648_platform_data pdata;
	...
	struct regulator_bulk_data supplies[ARRAY_SIZE(rt5648_supply_names)];
	struct rt5648_eq_param_s *eq_param;
...
static bool rt5648_volatile_register(struct device *dev, unsigned int reg)
{
	int i;

	for (i = 0; i < ARRAY_SIZE(rt5648_ranges); i++) {
		if (reg >= rt5648_ranges[i].range_min &&
			reg <= rt5648_ranges[i].range_max) {
			return true;
		}
	}
...
static bool rt5648_readable_register(struct device *dev, unsigned int reg)
{
	int i;
...
static int rt5648_hweq_info(struct snd_kcontrol *kcontrol,
			 struct snd_ctl_elem_info *uinfo)
{
	uinfo->type = SNDRV_CTL_ELEM_TYPE_BYTES;
	uinfo->count = RT5648_HWEQ_NUM * sizeof(struct rt5648_eq_param_s);

	return 0;
}

static int rt5648_hweq_get(struct snd_kcontrol *kcontrol,
			struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	struct rt5648_priv *rt5648 = snd_soc_component_get_drvdata(component);
	struct rt5648_eq_param_s *eq_param =
		(struct rt5648_eq_param_s *)ucontrol->value.bytes.data;
	int i;

	for (i = 0; i < RT5648_HWEQ_NUM; i++) {
		eq_param[i].reg = cpu_to_be16(rt5648->eq_param[i].reg);
		eq_param[i].val = cpu_to_be16(rt5648->eq_param[i].val);
	}

	return 0;
}

static bool rt5648_validate_hweq(unsigned short reg)
{
...
static int rt5648_hweq_put(struct snd_kcontrol *kcontrol,
			struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	struct rt5648_priv *rt5648 = snd_soc_component_get_drvdata(component);
	...
	/* The final setting of the table should be RT5648_EQ_CTRL2 */
	for (i = RT5648_HWEQ_NUM - 1; i >= 0; i--) {
		if (eq_param[i].reg == 0)
			continue;
		else if (eq_param[i].reg != RT5648_EQ_CTRL2)
			return 0;
		else
			break;
	}
	...
	for (i = 0; i < RT5648_HWEQ_NUM; i++) {
		if (!rt5648_validate_hweq(eq_param[i].reg) &&
			eq_param[i].reg != 0)
			return 0;
	...
	memcpy(rt5648->eq_param, eq_param,
		RT5648_HWEQ_NUM * sizeof(struct rt5648_eq_param_s));

	return 0;
}

#define RT5648_HWEQ(xname) \
{	.iface = SNDRV_CTL_ELEM_IFACE_MIXER, .name = xname, \
	.info = rt5648_hweq_info, \
	.get = rt5648_hweq_get, \
	.put = rt5648_hweq_put \
}

static int rt5648_spk_put_volsw(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	struct rt5648_priv *rt5648 = snd_soc_component_get_drvdata(component);
	...
	regmap_update_bits(rt5648->regmap, RT5648_MICBIAS,
		RT5648_PWR_CLK25M_MASK, RT5648_PWR_CLK25M_PU);

	ret = snd_soc_put_volsw(kcontrol, ucontrol);

	mod_delayed_work(system_power_efficient_wq, &rt5648->rcclock_work,
...
static const struct snd_kcontrol_new rt5648_snd_controls[] = {
	...
	SOC_DOUBLE("Speaker Channel Switch", RT5648_SPK_VOL,
		RT5648_VOL_L_SFT, RT5648_VOL_R_SFT, 1, 1),
	SOC_DOUBLE_EXT_TLV("Speaker Playback Volume", RT5648_SPK_VOL,
		RT5648_L_VOL_SFT, RT5648_R_VOL_SFT, 39, 1, snd_soc_get_volsw,
		rt5648_spk_put_volsw, out_vol_tlv),

	/* ClassD modulator Speaker Gain Ratio */
	SOC_SINGLE_TLV("Speaker ClassD Playback Volume", RT5648_SPO_CLSD_RATIO,
		RT5648_SPK_G_CLSD_SFT, 7, 0, spk_clsd_tlv),

	/* Headphone Output Volume */
	SOC_DOUBLE("Headphone Channel Switch", RT5648_HP_VOL,
		RT5648_VOL_L_SFT, RT5648_VOL_R_SFT, 1, 1),
	SOC_DOUBLE_TLV("Headphone Playback Volume", RT5648_HP_VOL,
	...
	SOC_DOUBLE_TLV("IN Capture Volume", RT5648_INL1_INR1_VOL,
		RT5648_INL_VOL_SFT, RT5648_INR_VOL_SFT, 31, 1, in_vol_tlv),

	/* ADC Digital Volume Control */
	SOC_DOUBLE("ADC Capture Switch", RT5648_STO1_ADC_DIG_VOL,
		RT5648_L_MUTE_SFT, RT5648_R_MUTE_SFT, 1, 1),
	SOC_DOUBLE_TLV("ADC Capture Volume", RT5648_STO1_ADC_DIG_VOL,
		RT5648_L_VOL_SFT + 1, RT5648_R_VOL_SFT + 1, 63, 0, adc_vol_tlv),
	SOC_DOUBLE("Mono ADC Capture Switch", RT5648_MONO_ADC_DIG_VOL,
		RT5648_L_MUTE_SFT, RT5648_R_MUTE_SFT, 1, 1),
	SOC_DOUBLE_TLV("Mono ADC Capture Volume", RT5648_MONO_ADC_DIG_VOL,
		RT5648_L_VOL_SFT + 1, RT5648_R_VOL_SFT + 1, 63, 0, adc_vol_tlv),

	/* ADC Boost Volume Control */
	SOC_DOUBLE_TLV("ADC Boost Capture Volume", RT5648_ADC_BST_VOL1,
		RT5648_STO1_ADC_L_BST_SFT, RT5648_STO1_ADC_R_BST_SFT, 3, 0,
		adc_bst_tlv),
	SOC_DOUBLE_TLV("Mono ADC Boost Capture Volume", RT5648_ADC_BST_VOL2,
		RT5648_MONO_ADC_L_BST_SFT, RT5648_MONO_ADC_R_BST_SFT, 3, 0,
		adc_bst_tlv),

	/* I2S2 function select */
	SOC_SINGLE("I2S2 Func Switch", RT5648_GPIO_CTRL1, RT5648_I2S2_SEL_SFT,
		1, 1),
	RT5648_HWEQ("Speaker HWEQ"),
};
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	rate = rt5648->sysclk / rl6231_get_pre_div(rt5648->regmap,
		RT5648_ADDA_CLK1, RT5648_I2S_PD1_SFT);
	idx = rl6231_calc_dmic_clk(rate);
	if (idx < 0)
		dev_err(codec->dev, "Failed to set DMIC clock\n");
	else
		snd_soc_update_bits(codec, RT5648_DMIC_CTRL1,
			RT5648_DMIC_CLK_MASK, idx << RT5648_DMIC_CLK_SFT);
	return idx;
}
			 ...
			 struct snd_soc_dapm_widget *sink)
{
	...
	val = snd_soc_read(codec, RT5648_GLB_CLK);
...
static int rt5648_enable_hweq(struct snd_soc_codec *codec)
{
	struct rt5648_priv *rt5648 = snd_soc_codec_get_drvdata(codec);
	int i;

	for (i = 0; i < RT5648_HWEQ_NUM; i++) {
		if (rt5648_validate_hweq(rt5648->eq_param[i].reg))
			regmap_write(rt5648->regmap, rt5648->eq_param[i].reg,
					rt5648->eq_param[i].val);
		else
			break;
	}
...
/**
 * rt5648_sel_asrc_clk_src - select ASRC clock source for a set of filters
 * @codec: SoC audio codec device.
 * @filter_mask: mask of filters.
 * @clk_src: clock source
 *
 * The ASRC function is for asynchronous MCLK and LRCK. Also, since RT5648 can
 ...
 */
int rt5648_sel_asrc_clk_src(struct snd_soc_codec *codec,
		unsigned int filter_mask, unsigned int clk_src)
{
	...
	switch (clk_src) {
	case RT5648_CLK_SEL_SYS:
	case RT5648_CLK_SEL_I2S1_ASRC:
	case RT5648_CLK_SEL_I2S2_ASRC:
	case RT5648_CLK_SEL_SYS2:
		break;
	...
	if (filter_mask & RT5648_DA_STEREO_FILTER) {
		asrc2_mask |= RT5648_DA_STO_CLK_SEL_MASK;
		asrc2_value = (asrc2_value & ~RT5648_DA_STO_CLK_SEL_MASK)
			| (clk_src << RT5648_DA_STO_CLK_SEL_SFT);
	}

	if (filter_mask & RT5648_DA_MONO_L_FILTER) {
		asrc2_mask |= RT5648_DA_MONOL_CLK_SEL_MASK;
		asrc2_value = (asrc2_value & ~RT5648_DA_MONOL_CLK_SEL_MASK)
			| (clk_src << RT5648_DA_MONOL_CLK_SEL_SFT);
	}

	if (filter_mask & RT5648_DA_MONO_R_FILTER) {
		asrc2_mask |= RT5648_DA_MONOR_CLK_SEL_MASK;
		asrc2_value = (asrc2_value & ~RT5648_DA_MONOR_CLK_SEL_MASK)
			| (clk_src << RT5648_DA_MONOR_CLK_SEL_SFT);
	}

	if (filter_mask & RT5648_AD_STEREO_FILTER) {
		asrc2_mask |= RT5648_AD_STO1_CLK_SEL_MASK;
		asrc2_value = (asrc2_value & ~RT5648_AD_STO1_CLK_SEL_MASK)
			| (clk_src << RT5648_AD_STO1_CLK_SEL_SFT);
	}

	if (filter_mask & RT5648_AD_MONO_L_FILTER) {
		asrc3_mask |= RT5648_AD_MONOL_CLK_SEL_MASK;
		asrc3_value = (asrc3_value & ~RT5648_AD_MONOL_CLK_SEL_MASK)
			| (clk_src << RT5648_AD_MONOL_CLK_SEL_SFT);
	}

	if (filter_mask & RT5648_AD_MONO_R_FILTER)  {
		asrc3_mask |= RT5648_AD_MONOR_CLK_SEL_MASK;
		asrc3_value = (asrc3_value & ~RT5648_AD_MONOR_CLK_SEL_MASK)
			| (clk_src << RT5648_AD_MONOR_CLK_SEL_SFT);
	}

	if (asrc2_mask)
		snd_soc_update_bits(codec, RT5648_ASRC_2,
			asrc2_mask, asrc2_value);

	if (asrc3_mask)
		snd_soc_update_bits(codec, RT5648_ASRC_3,
			asrc3_mask, asrc3_value);

	return 0;
}
EXPORT_SYMBOL_GPL(rt5648_sel_asrc_clk_src);
...
static const struct snd_kcontrol_new rt5648_dac_l_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DAC1 Switch", RT5648_AD_DA_MIXER,
...
static const char * const rt5648_dac1_src[] = {
...
static const char * const rt5648_dac12_src[] = {
...
static const char * const rt5648_dacr2_src[] = {
...
/* INL/R source */
static const char * const rt5648_inl_src[] = {
	"IN2P", "MonoP"
};
...
static const char * const rt5648_inr_src[] = {
	"IN2N", "MonoN"
};
...
/* Stereo1 ADC source */
/* MX-27 [12] */
static const char * const rt5648_stereo_adc1_src[] = {
	"DAC MIX", "ADC"
};
...
static const struct snd_kcontrol_new rt5648_sto_adc1_mux =
	SOC_DAPM_ENUM("Stereo1 ADC1 Mux", rt5648_stereo1_adc1_enum);

/* MX-27 [11] */
static const char * const rt5648_stereo_adc2_src[] = {
	"DAC MIX", "DMIC"
};
...
static const struct snd_kcontrol_new rt5648_sto_adc2_mux =
	SOC_DAPM_ENUM("Stereo1 ADC2 Mux", rt5648_stereo1_adc2_enum);

/* MX-27 [8] */
static const char * const rt5648_stereo_dmic_src[] = {
	"DMIC1", "DMIC2"
};
...
/* Mono ADC source */
/* MX-28 [12] */
static const char * const rt5648_mono_adc_l1_src[] = {
	"Mono DAC MIXL", "ADC"
};
...
/* MX-28 [11] */
static const char * const rt5648_mono_adc_l2_src[] = {
	"Mono DAC MIXL", "DMIC"
};
...
/* MX-28 [8] */
static const char * const rt5648_mono_dmic_src[] = {
	"DMIC1", "DMIC2"
};
...
/* MX-28 [4] */
static const char * const rt5648_mono_adc_r1_src[] = {
	"Mono DAC MIXR", "ADC"
};
...
/* MX-28 [3] */
static const char * const rt5648_mono_adc_r2_src[] = {
	"Mono DAC MIXR", "DMIC"
};
...
/* MX-77 [9:8] */
static const char * const rt5648_if1_adc_in_src[] = {
...
static const char * const rt5648_tdm_adc_swap_select[] = {
	"L/R", "R/L", "L/L", "R/R"
};

/* MX-77 [7:6][5:4][3:2] */
static SOC_ENUM_SINGLE_DECL(rt5648_tdm_adc_slot0_1_enum,
	RT5648_TDM_CTRL_1, 6, rt5648_tdm_adc_swap_select);

static const struct snd_kcontrol_new rt5648_if1_adc1_in_mux =
	SOC_DAPM_ENUM("IF1 ADC1 IN source", rt5648_tdm_adc_slot0_1_enum);

static SOC_ENUM_SINGLE_DECL(rt5648_tdm_adc_slot2_3_enum,
	RT5648_TDM_CTRL_1, 4, rt5648_tdm_adc_swap_select);

static const struct snd_kcontrol_new rt5648_if1_adc2_in_mux =
	SOC_DAPM_ENUM("IF1 ADC2 IN source", rt5648_tdm_adc_slot2_3_enum);

static SOC_ENUM_SINGLE_DECL(rt5648_tdm_adc_slot4_5_enum,
	RT5648_TDM_CTRL_1, 2, rt5648_tdm_adc_swap_select);

static const struct snd_kcontrol_new rt5648_if1_adc3_in_mux =
	SOC_DAPM_ENUM("IF1 ADC3 IN source", rt5648_tdm_adc_slot4_5_enum);

/* MX-79 [14:12][10:8][6:4][2:0] */
static const char * const rt5648_tdm_dac_swap_select[] = {
	"Slot0", "Slot1", "Slot2", "Slot3"
};

static SOC_ENUM_SINGLE_DECL(rt5648_tdm_dac0_enum,
	RT5648_TDM_CTRL_3, 12, rt5648_tdm_dac_swap_select);

static const struct snd_kcontrol_new rt5648_if1_dac0_tdm_sel_mux =
	SOC_DAPM_ENUM("IF1 DAC0 source", rt5648_tdm_dac0_enum);

static SOC_ENUM_SINGLE_DECL(rt5648_tdm_dac1_enum,
	RT5648_TDM_CTRL_3, 8, rt5648_tdm_dac_swap_select);

static const struct snd_kcontrol_new rt5648_if1_dac1_tdm_sel_mux =
	SOC_DAPM_ENUM("IF1 DAC1 source", rt5648_tdm_dac1_enum);

static SOC_ENUM_SINGLE_DECL(rt5648_tdm_dac2_enum,
	RT5648_TDM_CTRL_3, 4, rt5648_tdm_dac_swap_select);

static const struct snd_kcontrol_new rt5648_if1_dac2_tdm_sel_mux =
	SOC_DAPM_ENUM("IF1 DAC2 source", rt5648_tdm_dac2_enum);

static SOC_ENUM_SINGLE_DECL(rt5648_tdm_dac3_enum,
	RT5648_TDM_CTRL_3, 0, rt5648_tdm_dac_swap_select);

static const struct snd_kcontrol_new rt5648_if1_dac3_tdm_sel_mux =
	SOC_DAPM_ENUM("IF1 DAC3 source", rt5648_tdm_dac3_enum);

/* MX-2F [13:12] */
static const char * const rt5648_if2_adc_in_src[] = {
...
/* MX-2F [1:0] */
static const char * const rt5648_if3_adc_in_src[] = {
	"IF_ADC1", "IF_ADC2", "VAD_ADC"
};
...
/* MX-31 [15] [13] [11] [9] */
static const char * const rt5648_pdm_src[] = {
	"Mono DAC", "Stereo DAC"
};
...
/* MX-9D [9:8] */
static const char * const rt5648_vad_adc_src[] = {
...
static const struct snd_kcontrol_new spk_l_vol_control =
	SOC_DAPM_SINGLE_AUTODISABLE("Switch", RT5648_SPK_VOL,
		RT5648_L_MUTE_SFT, 1, 1);

static const struct snd_kcontrol_new spk_r_vol_control =
	SOC_DAPM_SINGLE_AUTODISABLE("Switch", RT5648_SPK_VOL,
		RT5648_R_MUTE_SFT, 1, 1);

static const struct snd_kcontrol_new hp_l_vol_control =
	SOC_DAPM_SINGLE_AUTODISABLE("Switch", RT5648_HP_VOL,
		RT5648_L_MUTE_SFT, 1, 1);
...
static const struct snd_kcontrol_new pdm1_l_vol_control =
	SOC_DAPM_SINGLE_AUTODISABLE("Switch", RT5648_PDM_OUT_CTRL,
		RT5648_M_PDM1_L, 1, 1);
...
static void hp_amp_power(struct snd_soc_codec *codec, int on)
{
	...
	if (on) {
		if (hp_amp_power_count <= 0) {
			...
			regmap_write(rt5648->regmap, RT5648_PR_BASE +
				RT5648_HP_DCC_INT1, 0x9f01);
			mdelay(150);
			...
			snd_soc_update_bits(codec, RT5648_PWR_VOL,
				...
				RT5648_PWR_HV_L | RT5648_PWR_HV_R);
			snd_soc_update_bits(codec, RT5648_PWR_ANLG1,
				RT5648_PWR_HP_L | RT5648_PWR_HP_R |
				RT5648_PWR_HA,
				RT5648_PWR_HP_L | RT5648_PWR_HP_R |
				RT5648_PWR_HA);
			mdelay(5);
		...
		if (hp_amp_power_count <= 0) {
			snd_soc_update_bits(codec, RT5648_DEPOP_M1,
				RT5648_HP_SG_MASK |
				RT5648_HP_L_SMT_MASK |
				RT5648_HP_R_SMT_MASK,
				RT5648_HP_SG_DIS |
				RT5648_HP_L_SMT_DIS |
				RT5648_HP_R_SMT_DIS);
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		snd_soc_update_bits(codec, RT5648_GEN_CTRL3,
			RT5648_DET_CLK_MASK, RT5648_DET_CLK_MODE1);
		break;

	case SND_SOC_DAPM_PRE_PMD:
		snd_soc_update_bits(codec, RT5648_GEN_CTRL3,
			RT5648_DET_CLK_MASK, RT5648_DET_CLK_DIS);
		snd_soc_write(codec, RT5648_EQ_CTRL2, 0);
		snd_soc_update_bits(codec, RT5648_PWR_DIG1,
			RT5648_PWR_CLS_D | RT5648_PWR_CLS_D_R |
...
static const struct snd_soc_dapm_widget rt5648_dapm_widgets[] = {
	...
	/* ASRC */
	SND_SOC_DAPM_SUPPLY_S("I2S1 ASRC", 1, RT5648_ASRC_1,
			      11, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY_S("I2S2 ASRC", 1, RT5648_ASRC_1,
			      12, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY_S("DAC STO ASRC", 1, RT5648_ASRC_1,
			      10, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY_S("DAC MONO L ASRC", 1, RT5648_ASRC_1,
			      9, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY_S("DAC MONO R ASRC", 1, RT5648_ASRC_1,
			      8, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY_S("DMIC STO1 ASRC", 1, RT5648_ASRC_1,
			      7, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY_S("DMIC MONO L ASRC", 1, RT5648_ASRC_1,
			      5, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY_S("DMIC MONO R ASRC", 1, RT5648_ASRC_1,
			      4, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY_S("ADC STO1 ASRC", 1, RT5648_ASRC_1,
			      3, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY_S("ADC MONO L ASRC", 1, RT5648_ASRC_1,
			      1, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY_S("ADC MONO R ASRC", 1, RT5648_ASRC_1,
			      0, 0, NULL, 0),
	...
	/* Boost */
	SND_SOC_DAPM_PGA("BST1", RT5648_PWR_ANLG2,
		RT5648_PWR_BST1_BIT, 0, NULL, 0),
	...
	SND_SOC_DAPM_SUPPLY_S("adc stereo1 filter", 1, RT5648_PWR_DIG2,
	...
	SND_SOC_DAPM_MIXER_E("Sto1 ADC MIXR", SND_SOC_NOPM, 0, 0,
		...
		NULL, 0),
	SND_SOC_DAPM_SUPPLY_S("adc mono left filter", 1, RT5648_PWR_DIG2,
		RT5648_PWR_ADC_MF_L_BIT, 0, NULL, 0),
	SND_SOC_DAPM_MIXER_E("Mono ADC MIXL", SND_SOC_NOPM, 0, 0,
		rt5648_mono_adc_l_mix, ARRAY_SIZE(rt5648_mono_adc_l_mix),
		NULL, 0),
	SND_SOC_DAPM_SUPPLY_S("adc mono right filter", 1, RT5648_PWR_DIG2,
	...
	/* DAC2 channel Mux */
	SND_SOC_DAPM_MUX("DAC L2 Mux", SND_SOC_NOPM, 0, 0, &rt5648_dac_l2_mux),
	SND_SOC_DAPM_MUX("DAC R2 Mux", SND_SOC_NOPM, 0, 0, &rt5648_dac_r2_mux),
	...
	SND_SOC_DAPM_MUX("DAC1 L Mux", SND_SOC_NOPM, 0, 0, &rt5648_dac1l_mux),
	SND_SOC_DAPM_MUX("DAC1 R Mux", SND_SOC_NOPM, 0, 0, &rt5648_dac1r_mux),

	/* DAC Mixer */
	SND_SOC_DAPM_SUPPLY_S("dac stereo1 filter", 1, RT5648_PWR_DIG2,
		RT5648_PWR_DAC_S1F_BIT, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY_S("dac mono left filter", 1, RT5648_PWR_DIG2,
		RT5648_PWR_DAC_MF_L_BIT, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY_S("dac mono right filter", 1, RT5648_PWR_DIG2,
	...
	/* DACs */
	SND_SOC_DAPM_DAC("DAC L1", NULL, RT5648_PWR_DIG1, RT5648_PWR_DAC_L1_BIT,
		0),
	SND_SOC_DAPM_DAC("DAC L2", NULL, RT5648_PWR_DIG1, RT5648_PWR_DAC_L2_BIT,
		0),
	SND_SOC_DAPM_DAC("DAC R1", NULL, RT5648_PWR_DIG1, RT5648_PWR_DAC_R1_BIT,
		0),
	SND_SOC_DAPM_DAC("DAC R2", NULL, RT5648_PWR_DIG1, RT5648_PWR_DAC_R2_BIT,
		0),
	/* OUT Mixer */
	...
	/* Ouput Volume */
	SND_SOC_DAPM_SWITCH("SPKVOL L", RT5648_PWR_VOL, RT5648_PWR_SV_L_BIT, 0,
		&spk_l_vol_control),
	SND_SOC_DAPM_SWITCH("SPKVOL R", RT5648_PWR_VOL, RT5648_PWR_SV_R_BIT, 0,
		&spk_r_vol_control),
	SND_SOC_DAPM_MIXER("HPOVOL MIXL", RT5648_PWR_VOL, RT5648_PWR_HV_L_BIT,
		0, rt5648_hpvoll_mix, ARRAY_SIZE(rt5648_hpvoll_mix)),
	SND_SOC_DAPM_MIXER("HPOVOL MIXR", RT5648_PWR_VOL, RT5648_PWR_HV_R_BIT,
		0, rt5648_hpvolr_mix, ARRAY_SIZE(rt5648_hpvolr_mix)),
	SND_SOC_DAPM_SUPPLY("HPOVOL MIXL Power", RT5648_PWR_MIXER,
		RT5648_PWR_HM_L_BIT, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY("HPOVOL MIXR Power", RT5648_PWR_MIXER,
		RT5648_PWR_HM_R_BIT, 0, NULL, 0),
	...
	/* HPO/LOUT/Mono Mixer */
	SND_SOC_DAPM_MIXER("SPOL MIX", SND_SOC_NOPM, 0, 0, rt5648_spo_l_mix,
		ARRAY_SIZE(rt5648_spo_l_mix)),
	SND_SOC_DAPM_MIXER("SPOR MIX", SND_SOC_NOPM, 0, 0, rt5648_spo_r_mix,
		ARRAY_SIZE(rt5648_spo_r_mix)),
	SND_SOC_DAPM_MIXER("HPO MIX", SND_SOC_NOPM, 0, 0, rt5648_hpo_mix,
		ARRAY_SIZE(rt5648_hpo_mix)),
	SND_SOC_DAPM_MIXER("LOUT MIX", SND_SOC_NOPM, 0, 0, rt5648_lout_mix,
		ARRAY_SIZE(rt5648_lout_mix)),

	SND_SOC_DAPM_PGA_S("HP amp", 1, SND_SOC_NOPM, 0, 0, rt5648_hp_event,
		SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMU),
	SND_SOC_DAPM_PGA_S("LOUT amp", 1, SND_SOC_NOPM, 0, 0, rt5648_lout_event,
		SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMU),
	SND_SOC_DAPM_PGA_S("SPK amp", 2, SND_SOC_NOPM, 0, 0, rt5648_spk_event,
		SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMU),

	/* PDM */
	SND_SOC_DAPM_SUPPLY("PDM1 Power", RT5648_PWR_DIG2, RT5648_PWR_PDM1_BIT,
		0, NULL, 0),
	SND_SOC_DAPM_MUX("PDM1 L Mux", SND_SOC_NOPM, 0, 0, &rt5648_pdm1_l_mux),
	SND_SOC_DAPM_MUX("PDM1 R Mux", SND_SOC_NOPM, 0, 0, &rt5648_pdm1_r_mux),
...
static const struct snd_soc_dapm_widget rt5648_specific_dapm_widgets[] = {
	SND_SOC_DAPM_MUX("RT5648 IF1 DAC1 L Mux", SND_SOC_NOPM, 0, 0,
		&rt5648_if1_dac0_tdm_sel_mux),
	SND_SOC_DAPM_MUX("RT5648 IF1 DAC1 R Mux", SND_SOC_NOPM, 0, 0,
		&rt5648_if1_dac1_tdm_sel_mux),
	SND_SOC_DAPM_MUX("RT5648 IF1 DAC2 L Mux", SND_SOC_NOPM, 0, 0,
		&rt5648_if1_dac2_tdm_sel_mux),
	SND_SOC_DAPM_MUX("RT5648 IF1 DAC2 R Mux", SND_SOC_NOPM, 0, 0,
		&rt5648_if1_dac3_tdm_sel_mux),
	SND_SOC_DAPM_MUX("RT5648 IF1 ADC Mux", SND_SOC_NOPM,
		0, 0, &rt5648_if1_adc_in_mux),
	SND_SOC_DAPM_MUX("RT5648 IF1 ADC1 Swap Mux", SND_SOC_NOPM,
		0, 0, &rt5648_if1_adc1_in_mux),
	SND_SOC_DAPM_MUX("RT5648 IF1 ADC2 Swap Mux", SND_SOC_NOPM,
		0, 0, &rt5648_if1_adc2_in_mux),
	SND_SOC_DAPM_MUX("RT5648 IF1 ADC3 Swap Mux", SND_SOC_NOPM,
		0, 0, &rt5648_if1_adc3_in_mux),
};
...
static const struct snd_soc_dapm_route rt5648_specific_dapm_routes[] = {
	{ "DAC L1", NULL, "Stereo DAC MIXL" },
	{ "DAC R1", NULL, "Stereo DAC MIXR" },
	{ "DAC L2", NULL, "Mono DAC MIXL" },
	{ "DAC R2", NULL, "Mono DAC MIXR" },

	{ "RT5648 IF1 ADC1 Swap Mux", "L/R", "IF_ADC1" },
	{ "RT5648 IF1 ADC1 Swap Mux", "R/L", "IF_ADC1" },
	{ "RT5648 IF1 ADC1 Swap Mux", "L/L", "IF_ADC1" },
	{ "RT5648 IF1 ADC1 Swap Mux", "R/R", "IF_ADC1" },

	{ "RT5648 IF1 ADC2 Swap Mux", "L/R", "IF_ADC2" },
	{ "RT5648 IF1 ADC2 Swap Mux", "R/L", "IF_ADC2" },
	{ "RT5648 IF1 ADC2 Swap Mux", "L/L", "IF_ADC2" },
	{ "RT5648 IF1 ADC2 Swap Mux", "R/R", "IF_ADC2" },

	{ "RT5648 IF1 ADC3 Swap Mux", "L/R", "VAD_ADC" },
	{ "RT5648 IF1 ADC3 Swap Mux", "R/L", "VAD_ADC" },
	{ "RT5648 IF1 ADC3 Swap Mux", "L/L", "VAD_ADC" },
	{ "RT5648 IF1 ADC3 Swap Mux", "R/R", "VAD_ADC" },

	{ "IF1 ADC", NULL, "RT5648 IF1 ADC1 Swap Mux" },
	{ "IF1 ADC", NULL, "RT5648 IF1 ADC2 Swap Mux" },
	{ "IF1 ADC", NULL, "RT5648 IF1 ADC3 Swap Mux" },

	{ "RT5648 IF1 ADC Mux", "IF_ADC1/IF_ADC2/VAD_ADC", "IF1 ADC" },
	{ "RT5648 IF1 ADC Mux", "IF_ADC2/IF_ADC1/VAD_ADC", "IF1 ADC" },
	{ "RT5648 IF1 ADC Mux", "VAD_ADC/IF_ADC1/IF_ADC2", "IF1 ADC" },
	{ "RT5648 IF1 ADC Mux", "VAD_ADC/IF_ADC2/IF_ADC1", "IF1 ADC" },
	{ "AIF1TX", NULL, "RT5648 IF1 ADC Mux" },

	{ "RT5648 IF1 DAC1 L Mux", "Slot0", "IF1 DAC0" },
	{ "RT5648 IF1 DAC1 L Mux", "Slot1", "IF1 DAC1" },
	{ "RT5648 IF1 DAC1 L Mux", "Slot2", "IF1 DAC2" },
	{ "RT5648 IF1 DAC1 L Mux", "Slot3", "IF1 DAC3" },

	{ "RT5648 IF1 DAC1 R Mux", "Slot0", "IF1 DAC0" },
	{ "RT5648 IF1 DAC1 R Mux", "Slot1", "IF1 DAC1" },
	{ "RT5648 IF1 DAC1 R Mux", "Slot2", "IF1 DAC2" },
	{ "RT5648 IF1 DAC1 R Mux", "Slot3", "IF1 DAC3" },

	{ "RT5648 IF1 DAC2 L Mux", "Slot0", "IF1 DAC0" },
	{ "RT5648 IF1 DAC2 L Mux", "Slot1", "IF1 DAC1" },
	{ "RT5648 IF1 DAC2 L Mux", "Slot2", "IF1 DAC2" },
	{ "RT5648 IF1 DAC2 L Mux", "Slot3", "IF1 DAC3" },

	{ "RT5648 IF1 DAC2 R Mux", "Slot0", "IF1 DAC0" },
	{ "RT5648 IF1 DAC2 R Mux", "Slot1", "IF1 DAC1" },
	{ "RT5648 IF1 DAC2 R Mux", "Slot2", "IF1 DAC2" },
	{ "RT5648 IF1 DAC2 R Mux", "Slot3", "IF1 DAC3" },

	{ "DAC1 L Mux", "IF1 DAC", "RT5648 IF1 DAC1 L Mux" },
	{ "DAC1 R Mux", "IF1 DAC", "RT5648 IF1 DAC1 R Mux" },

	{ "DAC L2 Mux", "IF1 DAC", "RT5648 IF1 DAC2 L Mux" },
	{ "DAC R2 Mux", "IF1 DAC", "RT5648 IF1 DAC2 R Mux" },
};
	...
	struct snd_pcm_hw_params *params, struct snd_soc_dai *dai)
{
	...
	pre_div = rl6231_get_clk_info(rt5648->sysclk, rt5648->lrck[dai->id]);
	if (pre_div < 0) {
	...
	switch (dai->id) {
	case RT5648_AIF1:
		mask_clk = RT5648_I2S_PD1_MASK;
		val_clk = pre_div << RT5648_I2S_PD1_SFT;
...
static int rt5648_button_detect(struct snd_soc_codec *codec)
{
	return 0x0000;
}

static irqreturn_t rt5648_irq(int irq, void *data);

int rt5648_set_jack_detect(struct snd_soc_codec *codec,
	struct snd_soc_jack *hp_jack, struct snd_soc_jack *mic_jack,
	struct snd_soc_jack *btn_jack)
{
	struct rt5648_priv *rt5648 = snd_soc_codec_get_drvdata(codec);

	rt5648->hp_jack = hp_jack;
	rt5648->mic_jack = mic_jack;
	rt5648->btn_jack = btn_jack;
	rt5648_irq(0, rt5648);

	return 0;
}
EXPORT_SYMBOL_GPL(rt5648_set_jack_detect);

static void rt5648_jack_detect_work(struct work_struct *work)
{
	struct rt5648_priv *rt5648 =
		container_of(work, struct rt5648_priv, jack_detect_work.work);
	int val, btn_type, gpio_state = 0, report = 0;

	if (!rt5648->codec)
		return;

	switch (rt5648->pdata.jd_mode) {
	case 0: /* Not using rt5648 JD */
		if (rt5648->gpiod_hp_det) {
			gpio_state = gpiod_get_value(rt5648->gpiod_hp_det);
			dev_dbg(rt5648->codec->dev, "gpio_state = %d\n",
				gpio_state);
			report = rt5648_jack_detect(rt5648->codec, gpio_state);
		}
		snd_soc_jack_report(rt5648->hp_jack,
				    report, SND_JACK_HEADPHONE);
		snd_soc_jack_report(rt5648->mic_jack,
				    report, SND_JACK_MICROPHONE);
		return;
	case 1: /* 2 port */
		val = snd_soc_read(rt5648->codec, RT5648_A_JD_CTRL1) & 0x0070;
		break;
	default: /* 1 port */
		val = snd_soc_read(rt5648->codec, RT5648_A_JD_CTRL1) & 0x0020;
		break;
	...
	case 0x0: /* 1 port or 2 port */
		if (rt5648->jack_type == 0) {
			report = rt5648_jack_detect(rt5648->codec, 1);
			/* for push button and jack out */
			break;
		}
		btn_type = 0;
		if (snd_soc_read(rt5648->codec, RT5648_INT_IRQ_ST) & 0x4) {
			/* button pressed */
			report = SND_JACK_HEADSET;
			btn_type = rt5648_button_detect(rt5648->codec);
		...
		if (btn_type == 0)/* button release */
			report =  rt5648->jack_type;
		else {
			if (rt5648->pdata.jd_invert) {
				mod_timer(&rt5648->btn_check_timer,
	...
	case 0x20: /* 1 port */
		report = 0;
		snd_soc_update_bits(rt5648->codec,
				    RT5648_INT_IRQ_ST, 0x1, 0x0);
		rt5648_jack_detect(rt5648->codec, 0);
		break;
	default:
		break;
	}

	snd_soc_jack_report(rt5648->hp_jack, report, SND_JACK_HEADPHONE);
	snd_soc_jack_report(rt5648->mic_jack, report, SND_JACK_MICROPHONE);
	if (rt5648->en_button_func)
		snd_soc_jack_report(rt5648->btn_jack,
			report, SND_JACK_BTN_0 | SND_JACK_BTN_1 |
				SND_JACK_BTN_2 | SND_JACK_BTN_3);
}

static void rt5648_rcclock_work(struct work_struct *work)
{
	struct rt5648_priv *rt5648 =
		container_of(work, struct rt5648_priv, rcclock_work.work);

	regmap_update_bits(rt5648->regmap, RT5648_MICBIAS,
		RT5648_PWR_CLK25M_MASK, RT5648_PWR_CLK25M_PD);
}

static irqreturn_t rt5648_irq(int irq, void *data)
{
	struct rt5648_priv *rt5648 = data;

	queue_delayed_work(system_power_efficient_wq,
			   &rt5648->jack_detect_work, msecs_to_jiffies(250));

	return IRQ_HANDLED;
}

static void rt5648_btn_check_callback(unsigned long data)
{
	struct rt5648_priv *rt5648 = (struct rt5648_priv *)data;

	queue_delayed_work(system_power_efficient_wq,
		   &rt5648->jack_detect_work, msecs_to_jiffies(5));
}
...
static int rt5648_probe(struct snd_soc_codec *codec)
{
	...
	snd_soc_dapm_new_controls(dapm,
		rt5648_specific_dapm_widgets,
		ARRAY_SIZE(rt5648_specific_dapm_widgets));
	snd_soc_dapm_add_routes(dapm,
		rt5648_specific_dapm_routes,
		ARRAY_SIZE(rt5648_specific_dapm_routes));

	snd_soc_codec_force_bias_level(codec, SND_SOC_BIAS_OFF);

	/* for JD function */
	if (rt5648->pdata.jd_mode) {
		snd_soc_dapm_force_enable_pin(dapm, "JD Power");
		snd_soc_dapm_force_enable_pin(dapm, "LDO2");
		snd_soc_dapm_sync(dapm);
	}

	rt5648->eq_param = devm_kzalloc(codec->dev,
		RT5648_HWEQ_NUM * sizeof(struct rt5648_eq_param_s), GFP_KERNEL);
...
static int rt5648_suspend(struct snd_soc_codec *codec)
{
	...
	regcache_cache_only(rt5648->regmap, true);
	regcache_mark_dirty(rt5648->regmap);
...
static int rt5648_resume(struct snd_soc_codec *codec)
{
	...
	regcache_cache_only(rt5648->regmap, false);
	regcache_sync(rt5648->regmap);
...
static const struct snd_soc_dai_ops rt5648_aif_dai_ops = {
...
static struct snd_soc_dai_driver rt5648_dai[] = {
	{
		.name = "rt5648-aif1",
		.id = RT5648_AIF1,
		.playback = {
...
static const struct regmap_config rt5648_regmap = {
	.reg_bits = 8,
	.val_bits = 16,
	.use_single_rw = true,
	.max_register = RT5648_VENDOR_ID2 + 1 + (ARRAY_SIZE(rt5648_ranges) *
					       RT5648_PR_SPACING),
	.volatile_reg = rt5648_volatile_register,
	.readable_reg = rt5648_readable_register,

	.cache_type = REGCACHE_RBTREE,
	.reg_defaults = rt5648_reg,
	.num_reg_defaults = ARRAY_SIZE(rt5648_reg),
	.ranges = rt5648_ranges,
...
#ifdef CONFIG_ACPI
static const struct acpi_device_id rt5648_acpi_match[] = {
	{ "10EC5648", 0 },
	{},
};
		    ...
		    const struct i2c_device_id *id)
{
	...
	if (IS_ERR(rt5648->gpiod_hp_det)) {
		dev_err(&i2c->dev, "failed to initialize gpiod\n");
		return PTR_ERR(rt5648->gpiod_hp_det);
	}

	for (i = 0; i < ARRAY_SIZE(rt5648->supplies); i++)
		rt5648->supplies[i].supply = rt5648_supply_names[i];

	ret = devm_regulator_bulk_get(&i2c->dev,
				      ARRAY_SIZE(rt5648->supplies),
				      rt5648->supplies);
	if (ret) {
	...
	ret = regulator_bulk_enable(ARRAY_SIZE(rt5648->supplies),
				    rt5648->supplies);
	if (ret) {
	...
	ret = regmap_register_patch(rt5648->regmap, init_list,
	...
	if (rt5648->pdata.dmic1_data_pin || rt5648->pdata.dmic2_data_pin) {
		regmap_update_bits(rt5648->regmap, RT5648_GPIO_CTRL1,
			RT5648_GP2_PIN_MASK, RT5648_GP2_PIN_DMIC1_SCL);
	}
	switch (rt5648->pdata.dmic1_data_pin) {
	case RT5648_DMIC_DATA_IN2N:
		regmap_update_bits(rt5648->regmap, RT5648_DMIC_CTRL1,
			RT5648_DMIC_1_DP_MASK, RT5648_DMIC_1_DP_IN2N);
		break;

	case RT5648_DMIC_DATA_GPIO5:
		regmap_update_bits(rt5648->regmap, RT5648_GPIO_CTRL1,
			RT5648_I2S2_DAC_PIN_MASK, RT5648_I2S2_DAC_PIN_GPIO);
		regmap_update_bits(rt5648->regmap, RT5648_DMIC_CTRL1,
			RT5648_DMIC_1_DP_MASK, RT5648_DMIC_1_DP_GPIO5);
		regmap_update_bits(rt5648->regmap, RT5648_GPIO_CTRL1,
			RT5648_GP5_PIN_MASK, RT5648_GP5_PIN_DMIC1_SDA);
		break;

	case RT5648_DMIC_DATA_GPIO11:
		regmap_update_bits(rt5648->regmap, RT5648_DMIC_CTRL1,
			RT5648_DMIC_1_DP_MASK, RT5648_DMIC_1_DP_GPIO11);
		regmap_update_bits(rt5648->regmap, RT5648_GPIO_CTRL1,
			RT5648_GP11_PIN_MASK,
			RT5648_GP11_PIN_DMIC1_SDA);
		break;
	...
	switch (rt5648->pdata.dmic2_data_pin) {
	case RT5648_DMIC_DATA_IN2P:
		regmap_update_bits(rt5648->regmap, RT5648_DMIC_CTRL1,
			RT5648_DMIC_2_DP_MASK, RT5648_DMIC_2_DP_IN2P);
		break;

	case RT5648_DMIC_DATA_GPIO6:
		regmap_update_bits(rt5648->regmap, RT5648_DMIC_CTRL1,
			RT5648_DMIC_2_DP_MASK, RT5648_DMIC_2_DP_GPIO6);
		regmap_update_bits(rt5648->regmap, RT5648_GPIO_CTRL1,
			RT5648_GP6_PIN_MASK, RT5648_GP6_PIN_DMIC2_SDA);
		break;

	case RT5648_DMIC_DATA_GPIO10:
		regmap_update_bits(rt5648->regmap, RT5648_DMIC_CTRL1,
			RT5648_DMIC_2_DP_MASK, RT5648_DMIC_2_DP_GPIO10);
		regmap_update_bits(rt5648->regmap, RT5648_GPIO_CTRL1,
			RT5648_GP10_PIN_MASK,
			RT5648_GP10_PIN_DMIC2_SDA);
		break;

	case RT5648_DMIC_DATA_GPIO12:
		regmap_update_bits(rt5648->regmap, RT5648_DMIC_CTRL1,
			RT5648_DMIC_2_DP_MASK, RT5648_DMIC_2_DP_GPIO12);
		regmap_update_bits(rt5648->regmap, RT5648_GPIO_CTRL1,
			RT5648_GP12_PIN_MASK,
			RT5648_GP12_PIN_DMIC2_SDA);
		break;
	...
	if (rt5648->pdata.jd_mode) {
		regmap_update_bits(rt5648->regmap, RT5648_GEN_CTRL3,
				   RT5648_IRQ_CLK_GATE_CTRL,
				   RT5648_IRQ_CLK_GATE_CTRL);
		regmap_update_bits(rt5648->regmap, RT5648_MICBIAS,
				   RT5648_IRQ_CLK_INT, RT5648_IRQ_CLK_INT);
		regmap_update_bits(rt5648->regmap, RT5648_IRQ_CTRL2,
				   RT5648_IRQ_JD_1_1_EN, RT5648_IRQ_JD_1_1_EN);
		regmap_update_bits(rt5648->regmap, RT5648_GEN_CTRL3,
				   RT5648_JD_PSV_MODE, RT5648_JD_PSV_MODE);
		regmap_update_bits(rt5648->regmap, RT5648_HPO_MIXER,
				   RT5648_IRQ_PSV_MODE, RT5648_IRQ_PSV_MODE);
		regmap_update_bits(rt5648->regmap, RT5648_MICBIAS,
				   RT5648_MIC2_OVCD_EN, RT5648_MIC2_OVCD_EN);
		regmap_update_bits(rt5648->regmap, RT5648_GPIO_CTRL1,
				   RT5648_GP1_PIN_IRQ, RT5648_GP1_PIN_IRQ);
		switch (rt5648->pdata.jd_mode) {
		case 1:
			regmap_update_bits(rt5648->regmap, RT5648_A_JD_CTRL1,
					   RT5648_JD1_MODE_MASK,
					   RT5648_JD1_MODE_0);
			break;
		case 2:
			regmap_update_bits(rt5648->regmap, RT5648_A_JD_CTRL1,
	...
	if (rt5648->pdata.jd_invert) {
		regmap_update_bits(rt5648->regmap, RT5648_IRQ_CTRL2,
			RT5648_JD_1_1_MASK, RT5648_JD_1_1_INV);
		setup_timer(&rt5648->btn_check_timer,
			rt5648_btn_check_callback, (unsigned long)rt5648);
	}

	INIT_DELAYED_WORK(&rt5648->jack_detect_work, rt5648_jack_detect_work);
	INIT_DELAYED_WORK(&rt5648->rcclock_work, rt5648_rcclock_work);

	if (rt5648->i2c->irq) {
		ret = request_threaded_irq(rt5648->i2c->irq, NULL, rt5648_irq,
			IRQF_TRIGGER_RISING | IRQF_TRIGGER_FALLING
			| IRQF_ONESHOT, "rt5648", rt5648);
		if (ret) {
...
err_irq:
	if (rt5648->i2c->irq)
		free_irq(rt5648->i2c->irq, rt5648);
err_enable:
	regulator_bulk_disable(ARRAY_SIZE(rt5648->supplies), rt5648->supplies);
	return ret;
}

static int rt5648_i2c_remove(struct i2c_client *i2c)
{
	struct rt5648_priv *rt5648 = i2c_get_clientdata(i2c);

	if (i2c->irq)
		free_irq(i2c->irq, rt5648);

	cancel_delayed_work_sync(&rt5648->jack_detect_work);
	cancel_delayed_work_sync(&rt5648->rcclock_work);
...
static void rt5648_i2c_shutdown(struct i2c_client *i2c)
{
	struct rt5648_priv *rt5648 = i2c_get_clientdata(i2c);
...
static struct i2c_driver rt5648_i2c_driver = {
	.driver = {
		.name = "rt5648",
		.acpi_match_table = ACPI_PTR(rt5648_acpi_match),
	},
...
module_i2c_driver(rt5648_i2c_driver);
